...
<section style="margin-bottom:2.5rem;">
<h2 class="section-title">
  <span class="lang-zh">课外活动</span>
  <span class="lang-en">Extracurricular Activities</span>
</h2>
<div class="timeline">

  <div class="timeline-entry animate-fade-in">
    <div class="timeline-date">Jul 2023</div>
    <div class="timeline-title">NUS School of Computing Summer Workshop</div>
    <ul>
      <li>Researched the BREACH attack, analyzing its characteristics and mechanisms.</li>
      <li>Developed a comprehensive simulation system of the BREACH attack for educational purposes.</li>
    </ul>
  </div>
...
<div class="skills-grid">
  ...
  <div class="skill-group animate-fade-in">
    <h3>
      <span class="lang-zh">编程语言</span>
  ...
  <div class="skill-group animate-fade-in">
    <h3>
      <span class="lang-zh">测试与安全</span>
      <span class="lang-en">Testing & Security</span>
    </h3>
    <div class="skill-tags">
      <span class="tag">GUI Testing</span>
      <span class="tag">Mobile Testing</span>
      <span class="tag">Web App Testing</span>
